...
FaviconURL		= 'https://media.nullcoreproject.net/i/fed35583.jpg';

ChannelName		= 'TTM';

MiniLogoURL		= 'https://media.nullcoreproject.net/i/fed35583.jpg';
...
CustomFooterHTML	= 'Bruh this shit sucks';
...
function playerMascot(mode) {
	if (mode == "hide") {
		...
		var arr = [
			['Ricardo', DROPBOX + 'jsrt38tp620ri9f/1547683717666.gif'],
			['Crash', DROPBOX + '78hiss50lmlw3a4/1542154936367.gif'],
			['Cringe', DROPBOX + 'je6owthtawuubkr/6.gif'],
		];
